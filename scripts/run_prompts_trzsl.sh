...
for dataset_dir in '/Users/menga/Desktop/github/zsl_taglets/development' ; do # add here the path to the folder containing dataset folders
...
for optim_seed in 1; do # 1 2 3 4 5 are the seeds we used
    ...
    accelerate launch --config_file methods_config/accelerate_localtest_config.yml run_main_trzsl.py --model_config ${model}_config.yml \
